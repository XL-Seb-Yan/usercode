...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/UserCode/AFanfani/X3872Analysis/Configuration/GenProduction/python/PYTHIA6_X3872ToJPsi_7TeV_Singlet_Priv2011_cff.py,v $')
)
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(2781000.0),  #Pythia Value, not corrected
